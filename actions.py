...
def check_home():
    ...
    WebDriverWait(driver, 3).until(EC.visibility_of_element_located(Locators.loginText))
...
def enter_info(email, password):
    ...
    WebDriverWait(driver, 3).until(EC.visibility_of_element_located(Locators.text))
